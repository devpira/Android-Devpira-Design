...
public class PiraRelativeLayout extends RelativeLayout {
    ...
    public PiraRelativeLayout(Context context) {
        super(context);
    ...
    public PiraRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            viewWidth = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meWidth,pWidth,pHeight,0);
            viewHeight = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meHeight,pHeight,pWidth,0);
            ...
            setX(typedArray.getFraction(R.styleable.PiraRelativeLayout_meX,pWidth,pHeight,0));
            setY(typedArray.getFraction(R.styleable.PiraRelativeLayout_meY,pHeight,pWidth,0));

            //Following sets margins if any:
            int margin = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meMargin, pWidth,pHeight,0);
            if(margin == 0) {                                                                                               //If margin is set then all
                leftMargin = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meLeftMargin, pWidth, pHeight, 0);        // individual margins will be overridden
                rightMargin = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meRightMargin, pWidth, pHeight, 0);     // to the margin because margin takes priority
                topMargin = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meTopMargin, pHeight, pWidth, 0);
                bottomMargin = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meBottomMargin, pHeight, pWidth, 0);
            }else{
            ...
            int padding = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_mePadding,pWidth,pHeight,0);
            if(padding == 0) {                                                                                               //If padding is set then all
                leftPadding = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meLeftPadding, pWidth, pHeight, 0);        // individual padding will be overridden
                rightPadding = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meRightPadding, pWidth, pHeight, 0);     // to the padding because mePadding takes priority
                topPadding = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meTopPadding, pHeight, pWidth, 0);
                bottomPadding = (int) typedArray.getFraction(R.styleable.PiraRelativeLayout_meBottomPadding, pHeight, pWidth, 0);
            }else{
