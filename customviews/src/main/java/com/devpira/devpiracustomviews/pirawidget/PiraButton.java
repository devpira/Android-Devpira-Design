...
public class PiraButton extends AppCompatButton {
    ...
    public PiraButton(Context context) {
        super(context);
    ...
    public PiraButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        if(typedArraySet)
            return;
        try {
            ref = typedArray.getResourceId(R.styleable.PiraButton_meParentView,0);
            ...
            viewWidth = (int) typedArray.getFraction(R.styleable.PiraButton_meWidth,pWidth,pHeight,0);
            viewHeight = (int) typedArray.getFraction(R.styleable.PiraButton_meHeight,pHeight,pWidth,0);
            ...
            setX(typedArray.getFraction(R.styleable.PiraButton_meX,pWidth,pHeight,0));
            setY(typedArray.getFraction(R.styleable.PiraButton_meY,pHeight,pWidth,0));

            //Following sets margins if any:
            int margin = (int) typedArray.getFraction(R.styleable.PiraButton_meMargin, pWidth,pHeight,0);
            if(margin == 0) {                                                                                               //If margin is set then all
                leftMargin = (int) typedArray.getFraction(R.styleable.PiraButton_meLeftMargin, pWidth, pHeight, 0);        // individual margins will be overridden
                rightMargin = (int) typedArray.getFraction(R.styleable.PiraButton_meRightMargin, pWidth, pHeight, 0);     // to the margin because margin takes priority
                topMargin = (int) typedArray.getFraction(R.styleable.PiraButton_meTopMargin, pHeight, pWidth, 0);
                bottomMargin = (int) typedArray.getFraction(R.styleable.PiraButton_meBottomMargin, pHeight, pWidth, 0);
            }else{
            ...
            int padding = (int) typedArray.getFraction(R.styleable.PiraButton_mePadding,pWidth,pHeight,0);
            if(padding == 0) {                                                                                               //If padding is set then all
                leftPadding = (int) typedArray.getFraction(R.styleable.PiraButton_meLeftPadding, pWidth, pHeight, 0);        // individual padding will be overridden
                rightPadding = (int) typedArray.getFraction(R.styleable.PiraButton_meRightPadding, pWidth, pHeight, 0);     // to the padding because mePadding takes priority
                topPadding = (int) typedArray.getFraction(R.styleable.PiraButton_meTopPadding, pHeight, pWidth, 0);
                bottomPadding = (int) typedArray.getFraction(R.styleable.PiraButton_meBottomPadding, pHeight, pWidth, 0);
            }else{
            ...
            textSize = typedArray.getFraction(R.styleable.PiraButton_meTextSize, pWidth, pHeight, 0);
            maxTextSize = typedArray.getFraction(R.styleable.PiraButton_meMaxTextSize, pWidth, pHeight, 0);
            minTextSize = typedArray.getFraction(R.styleable.PiraButton_meMinTextSize, pWidth, pHeight, 0);
