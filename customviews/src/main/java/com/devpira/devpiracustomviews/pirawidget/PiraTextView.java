...
public class PiraTextView extends AppCompatTextView {
    ...
    public PiraTextView(Context context) {
        super(context);
    ...
    public PiraTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        if(typedArraySet)
            return;
        try {
            ref = typedArray.getResourceId(R.styleable.PiraRelativeLayout_meParentView,0);
            ...
            viewWidth = (int) typedArray.getFraction(R.styleable.PiraTextView_meWidth,pWidth,pHeight,0);
            viewHeight = (int) typedArray.getFraction(R.styleable.PiraTextView_meHeight,pHeight,pWidth,0);
            ...
            setX(typedArray.getFraction(R.styleable.PiraTextView_meX,pWidth,pHeight,0));
            setY(typedArray.getFraction(R.styleable.PiraTextView_meY,pHeight,pWidth,0));

            //Following sets margins if any:
            int margin = (int) typedArray.getFraction(R.styleable.PiraTextView_meMargin, pWidth,pHeight,0);
            if(margin == 0) {                                                                                               //If margin is set then all
                leftMargin = (int) typedArray.getFraction(R.styleable.PiraTextView_meLeftMargin, pWidth, pHeight, 0);        // individual margins will be overridden
                rightMargin = (int) typedArray.getFraction(R.styleable.PiraTextView_meRightMargin, pWidth, pHeight, 0);     // to the margin because margin takes priority
                topMargin = (int) typedArray.getFraction(R.styleable.PiraTextView_meTopMargin, pHeight, pWidth, 0);
                bottomMargin = (int) typedArray.getFraction(R.styleable.PiraTextView_meBottomMargin, pHeight, pWidth, 0);
            }else{
            ...
            int padding = (int) typedArray.getFraction(R.styleable.PiraTextView_mePadding,pWidth,pHeight,0);
            if(padding == 0) {                                                                                               //If padding is set then all
                leftPadding = (int) typedArray.getFraction(R.styleable.PiraTextView_meLeftPadding, pWidth, pHeight, 0);        // individual padding will be overridden
                rightPadding = (int) typedArray.getFraction(R.styleable.PiraTextView_meRightPadding, pWidth, pHeight, 0);     // to the padding because mePadding takes priority
                topPadding = (int) typedArray.getFraction(R.styleable.PiraTextView_meTopPadding, pHeight, pWidth, 0);
                bottomPadding = (int) typedArray.getFraction(R.styleable.PiraTextView_meBottomPadding, pHeight, pWidth, 0);
            }else{
                leftPadding = rightPadding = topPadding = bottomPadding = padding;
            }
            setPadding(leftPadding,topPadding,rightPadding,bottomPadding);
            //following sets text size:
            textSize = typedArray.getFraction(R.styleable.PiraTextView_meTextSize, pWidth, pHeight, 0);
            maxTextSize = typedArray.getFraction(R.styleable.PiraTextView_meMaxTextSize, pWidth, pHeight, 0);
            minTextSize = typedArray.getFraction(R.styleable.PiraTextView_meMinTextSize, pWidth, pHeight, 0);
    ...
    public void  meTextSize(float size){
        this.setMeTextSize(size/100f*pWidth,0f,0f);
    }

    public void  meTextSize(float size, float base){
        this.setMeTextSize(size/100f*base,0f,0f);
    }
    ...
    public void  meTextSize( float size, float maxSize, float minSize, float base){
        this.setMeTextSize(size/100f*base,maxSize/100f*base,minSize/100f*base);
    }
