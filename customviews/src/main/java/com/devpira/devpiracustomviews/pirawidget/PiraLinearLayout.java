 ...
 */
public class PiraLinearLayout extends LinearLayout {
    ...
    public PiraLinearLayout(Context context) {
        super(context);
    ...
    public PiraLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.pWidth = getContext().getResources().getDisplayMetrics().widthPixels;
        this.pHeight = getContext().getResources().getDisplayMetrics().heightPixels;

        typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.PiraLinearLayout, 0,0);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if(typedArraySet)
            return;
        try {
            ref = typedArray.getResourceId(R.styleable.PiraLinearLayout_meParentView,0);
            ...
            viewWidth = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meWidth,pWidth,pHeight,0);
            viewHeight = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meHeight,pHeight,pWidth,0);
            ...
            setX(typedArray.getFraction(R.styleable.PiraLinearLayout_meX,pWidth,pHeight,0));
            setY(typedArray.getFraction(R.styleable.PiraLinearLayout_meY,pHeight,pWidth,0));

            //Following sets margins if any:
            int margin = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meMargin, pWidth,pHeight,0);
            if(margin == 0) {                                                                                               //If margin is set then all
                leftMargin = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meLeftMargin, pWidth, pHeight, 0);        // individual margins will be overridden
                rightMargin = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meRightMargin, pWidth, pHeight, 0);     // to the margin because margin takes priority
                topMargin = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meTopMargin, pHeight, pWidth, 0);
                bottomMargin = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meBottomMargin, pHeight, pWidth, 0);
            }else{
            ...
            int padding = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_mePadding,pWidth,pHeight,0);
            if(padding == 0) {                                                                                               //If padding is set then all
                leftPadding = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meLeftPadding, pWidth, pHeight, 0);        // individual padding will be overridden
                rightPadding = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meRightPadding, pWidth, pHeight, 0);     // to the padding because mePadding takes priority
                topPadding = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meTopPadding, pHeight, pWidth, 0);
                bottomPadding = (int) typedArray.getFraction(R.styleable.PiraLinearLayout_meBottomPadding, pHeight, pWidth, 0);
            }else{
