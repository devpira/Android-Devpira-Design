...
/**
 * Created by pira.suriyakumaran on 10/23/2016.
 */

public class PiraCheckBox extends AppCompatCheckBox {
    ...
    public PiraCheckBox(Context context) {
        super(context);
    ...
    public PiraCheckBox(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            viewWidth = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meWidth,pWidth,pHeight,0);
            viewHeight = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meHeight,pHeight,pWidth,0);
            ...
            setX(typedArray.getFraction(R.styleable.PiraCheckBox_meX,pWidth,pHeight,0));
            setY(typedArray.getFraction(R.styleable.PiraCheckBox_meY,pHeight,pWidth,0));

            //Following sets margins if any:
            int margin = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meMargin, pWidth,pHeight,0);
            if(margin == 0) {                                                                                               //If margin is set then all
                leftMargin = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meLeftMargin, pWidth, pHeight, 0);        // individual margins will be overridden
                rightMargin = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meRightMargin, pWidth, pHeight, 0);     // to the margin because margin takes priority
                topMargin = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meTopMargin, pHeight, pWidth, 0);
                bottomMargin = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meBottomMargin, pHeight, pWidth, 0);
            }else{
            ...
            int padding = (int) typedArray.getFraction(R.styleable.PiraCheckBox_mePadding,pWidth,pHeight,0);
            if(padding == 0) {                                                                                               //If padding is set then all
                leftPadding = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meLeftPadding, pWidth, pHeight, 0);        // individual padding will be overridden
                rightPadding = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meRightPadding, pWidth, pHeight, 0);     // to the padding because mePadding takes priority
                topPadding = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meTopPadding, pHeight, pWidth, 0);
                bottomPadding = (int) typedArray.getFraction(R.styleable.PiraCheckBox_meBottomPadding, pHeight, pWidth, 0);
            }else{
            ...
            textSize = typedArray.getFraction(R.styleable.PiraCheckBox_meTextSize, pWidth, pHeight, 0);
            maxTextSize = typedArray.getFraction(R.styleable.PiraCheckBox_meMaxTextSize, pWidth, pHeight, 0);
            minTextSize = typedArray.getFraction(R.styleable.PiraCheckBox_meMinTextSize, pWidth, pHeight, 0);
